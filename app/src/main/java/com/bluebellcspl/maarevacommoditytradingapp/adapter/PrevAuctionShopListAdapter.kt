...
class PrevAuctionShopListAdapter(var context: Context, var dataList: ArrayList<PCADetailModel>) :
    RecyclerView.Adapter<PrevAuctionShopListAdapter.MyViewHolder>() {
    inner class MyViewHolder(var binding: ShopListAdapterBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(
            ShopListAdapterBinding.inflate(
