...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, "MAAREVA.db", null, 1) {
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("CREATE table PCAMaster (PCAId TEXT,StateId TEXT,StateName TEXT,DistrictId TEXT,DistrictName TEXT,APMCId TEXT,APMCName TEXT,CommodityId TEXT,CommodityName TEXT,PCAName TEXT,            PCAPhoneNumber TEXT,Mobile2 TEXT,Address TEXT,EmailId TEXT,BuyerId TEXT,RoleId TEXT,RoleName TEXT,AdharNo TEXT,PanCardNo TEXT,GSTNo TEXT,AdharPhoto TEXT,PanCardPhoto TEXT,GSTCertiPhoto TEXT,            LicenseCopyPhoto TEXT,ProfilePic TEXT,ApprStatus TEXT,GCACommission TEXT,PCACommission TEXT,IsActive TEXT,CompanyCode TEXT,CreateUser TEXT,CreateDate TEXT,UpdateUser TEXT,UpdateDate TEXT)")
    }
