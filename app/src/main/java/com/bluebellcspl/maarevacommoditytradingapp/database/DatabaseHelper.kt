...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, "MAAREVA.db", null, 1) {
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("CREATE table ShopMaster (APMCId TEXT,APMCName TEXT,StateId TEXT,StateName TEXT,DistrictId TEXT,DistrictName TEXT,ShopId TEXT primary key ,ShopNo TEXT,ShopName TEXT,ShortShopName TEXT,ShopAddress TEXT,CompanyCode TEXT,IsActive TEXT,CreateUser TEXT,CreateDate TEXT,UpdateUser TEXT,UpdateDate TEXT)")
        ...
        db?.execSQL("CREATE table NotificationMaster (NotificationId TEXT primary key,ShortMsg TEXT,FullMsg TEXT,FromRoleId TEXT,RoleName TEXT,ToRoleId TEXT,ToUserId TEXT,Name TEXT,Link TEXT,ISRead TEXT,ISSeen TEXT,CreateUser TEXT,Cdate TEXT)")
    }
