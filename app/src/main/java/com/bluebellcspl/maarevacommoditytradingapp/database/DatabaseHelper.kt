...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, "MAAREVA.db", null, 1) {
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("CREATE table APMCMaster (APMCId TEXT,APMCName TEXT,SrNo TEXT,Location TEXT,MarketCess TEXT,LabourCharges TEXT,TranportationCharges TEXT,NoOfShop TEXT,StateId TEXT,StateName TEXT,DistrictId TEXT,DistrictName TEXT,CityId TEXT,CityName TEXT,CompanyCode TEXT,IsActive TEXT,CreateUser TEXT,CreateDate TEXT,UpdateDate TEXT,UpdateUser TEXT)")
        db?.execSQL("CREATE table CommodityMaster (CommodityId TEXT primary key,CommodityName TEXT,GujaratiCommodityName TEXT,Bharti TEXT,CompanyCode TEXT,IsActive TEXT,CreateUser TEXT,CreateDate TEXT,UpdateUser TEXT,UpdateDate TEXT)")
        //APMC Commodity Integration
        db?.execSQL("CREATE table APMCIntCommodityMaster (InteId TEXT primary key,APMCId TEXT,APMCName TEXT,CommodityId TEXT,CommodityName TEXT,CommodityBhartiValue TEXT,IsActive TEXT,cdate TEXT,CreateUser TEXT,CreateDate TEXT,CreatedUserName TEXT)")

        db?.execSQL("CREATE table ShopMaster (APMCId TEXT,APMCName TEXT,StateId TEXT,StateName TEXT,DistrictId TEXT,DistrictName TEXT,ShopId TEXT primary key ,ShopNo TEXT,ShopName TEXT,ShopNoName TEXT,GujaratiShopNoName TEXT,ShortShopName TEXT,GujaratiShopName TEXT,GujaratiShortShopName TEXT,ShopAddress TEXT,CompanyCode TEXT,IsActive TEXT,CreateUser TEXT,CreateDate TEXT,UpdateUser TEXT,UpdateDate TEXT)")
        ...
        db?.execSQL("CREATE table BuyerData (BuyerId INTEGER primary key autoincrement,BuyerName TEXT,CreateDate TEXT)")
    }
