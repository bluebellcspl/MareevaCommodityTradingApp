...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, "MAAREVA.db", null, 1) {
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("CREATE table APMCIntCommodityMaster (InteId TEXT primary key,APMCId TEXT,APMCName TEXT,CommodityId TEXT,CommodityName TEXT,IsActive TEXT,cdate TEXT,CreateUser TEXT,CreateDate TEXT,CreatedUserName TEXT)")
